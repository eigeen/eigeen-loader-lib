...
//based on imgui.h file version "1.90.2 WIP" 19013 from Dear ImGui https://github.com/ocornut/imgui
...
CIMGUI_API void igBeginHorizontal_Str(const char* str_id,const ImVec2 size,float align)
{
    return ImGui::BeginHorizontal(str_id,size,align);
}
CIMGUI_API void igBeginHorizontal_Ptr(const void* ptr_id,const ImVec2 size,float align)
{
    return ImGui::BeginHorizontal(ptr_id,size,align);
}
CIMGUI_API void igBeginHorizontal_Int(int id,const ImVec2 size,float align)
{
...
CIMGUI_API void igBeginVertical_Str(const char* str_id,const ImVec2 size,float align)
{
    return ImGui::BeginVertical(str_id,size,align);
}
CIMGUI_API void igBeginVertical_Ptr(const void* ptr_id,const ImVec2 size,float align)
{
    return ImGui::BeginVertical(ptr_id,size,align);
}
CIMGUI_API void igBeginVertical_Int(int id,const ImVec2 size,float align)
{
...
CIMGUI_API ImGuiLayoutType ImGuiInternal_GetCurrentLayoutType(ImGuiID window_id)
{
    return ImGuiInternal::GetCurrentLayoutType(window_id);
}
CIMGUI_API void ImGuiInternal_UpdateItemRect(ImGuiID window_id,const ImVec2 min,const ImVec2 max)
{
    return ImGuiInternal::UpdateItemRect(window_id,min,max);
}
